...
export default function Search() {
    ...
    return (
        ...
        <div className='text-center pt-8 mb-24 flex'>
            ...
            <div className="bg-violet-700 w-[400px] h-[400px] rounded-full opacity-5 blur-3xl absolute top-4 right-4">
            </div>

            <div className="bg-blue-500 w-[400px] h-[400px] rounded-full opacity-5 blur-3xl absolute top-4 left-4">
            </div>
        ...
        <div className="sm:w-[440px] sm:h-[240px] w-[340px] h-[220px] mb-8 px-8 rounded-2xl flex justify-center bg-gradient-to-bl from-[#222222] to-[#121212] text-white shadow-lg flex-col z-40">
        <div>
